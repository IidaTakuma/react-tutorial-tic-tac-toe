...
function Game() {
  ...
  const turnPlayer = (
    FIRST_PLAYER === "X" ? history.length % 2 === 0 : history.length % 2 !== 0
  )
    ? "O"
    : "X";
      ...
      <div className="game">
        <div className="game-board">
          ...
          <Board
            ...
            winner={winner}
            turnPlayer={turnPlayer}
            setNextBoard={(nextBoard: BoardValue) => setNextBoard(nextBoard)}
          ></Board>
        </div>
